...
export type ControllerLayoutPreference = "auto" | "xbox" | "playstation";
export type SecurityRiskCategory = "Low Risk" | "Requires Investigation";
...
export interface UserPreferences {
  ...
  scanAfterDownloadComplete?: boolean;

...
import { Gamepad2, Shield, Wrench } from "lucide-react";
...
import { SettingsContextSecurity } from "./settings-context-security";
...
import { SettingsContextAppearance } from "./settings-context-appearance";
  ...
  const categories = useMemo(
    () => [
      ...
      },
      {
        ...
        label: t("controller", { defaultValue: "Controller" }),
        ...
        {({ currentCategoryId, setCurrentCategoryId, appearance }) => {
          ...
          const renderCategory = () => {
            ...
            if (selectedCategoryId === "appearance") {
              return <SettingsContextAppearance appearance={appearance} />;
            }
            ...
            if (selectedCategoryId === "security") {
              return <SettingsContextSecurity />;
            }
            ...
            if (selectedCategoryId === "controller") {
              return <SettingsContextController />;
            }

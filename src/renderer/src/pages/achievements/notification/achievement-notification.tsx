...
import AchievementLogo from "@renderer/assets/icons/logo.png";
  ...
  useEffect(() => {
    const unsubscribe = window.electron.onAchievementUnlocked(
      (position, achievements) => {
        ...
        // Override achievement icons with our logo
        const achievementsWithLogo = achievements.map(ach => ({
          ...ach,
          iconUrl: AchievementLogo,
        }));

        setAchievements((ach) => ach.concat(achievementsWithLogo));

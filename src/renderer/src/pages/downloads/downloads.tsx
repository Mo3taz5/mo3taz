...
export default function Downloads() {
  ...
  const libraryGroup: Record<string, LibraryGame[]> = useMemo(() => {
    ...
    const result = orderBy(
      ...
      /* Is actively downloading or extracting */
      const isExtracting =
        next.download.extracting || extraction?.visibleId === next.id;
      const isActiveDownload = next.download.status === "active";
      if (lastPacket?.gameId === next.id || isExtracting || isActiveDownload)

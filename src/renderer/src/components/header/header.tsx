...
import { setFilters, setLibrarySearchQuery, toggleControllerMode } from "@renderer/features";
...
export function Header() {
  ...
  return (
    <>
        ...
        <section className="header__section header__section--left">
          ...
          <button
            ...
            className={cn("header__action-button", {
              "header__action-button--active": isControllerMode,
            })}
            onClick={() => dispatch(toggleControllerMode())}
            data-tooltip-id="controller-mode-tooltip"
            data-tooltip-content={
              isControllerMode ? "Exit Big Screen" : "Enter Big Screen"
            }
      ...
      <Tooltip id="controller-mode-tooltip" style={{ zIndex: 1 }} />

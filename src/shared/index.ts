...
export const generateAchievementCustomNotificationTest = (
  t: any,
  language?: string,
  options: { isHidden?: boolean; isRare?: boolean; isPlatinum?: boolean; iconUrl?: string } = {}
  ...
  return {
    ...
    iconUrl: options.iconUrl ?? "https://cdn.losbroxas.org/favicon.svg",
    points: 2440,

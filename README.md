...
[<img src="https://raw.githubusercontent.com/hydralauncher/hydra/refs/heads/main/resources/icon.png" width="144"/>](https://help.mo3taz.gg)

  <h1 align="center">Mo3taz Launcher</h1>

  <p align="center">
    <strong>Mo3taz Launcher is an open-source gaming platform created to be the single tool that you need in order to manage your gaming library. Mo3taz is written in Node.js (Electron, React, Typescript), Python, and Rust.</strong>
  </p>
...
![꧁MO3TAZ꧂ Launcher Home Page](./docs/screenshot.png)
...
- Save your game progress in the cloud with ꧁MO3TAZ꧂ Cloud
- Unlock achievements
...
꧁MO3TAZ꧂ is licensed under the [MIT License](LICENSE).
